		...
		-->
			...
			<div class="row center-align" style="margin-bottom: 8%">
				<div class="col m4 hoverable" style="padding: 2%; background: rgba(255, 255, 255, 0.8); min-height: 450px; color: #34495e">
					<h4>Impression 3D</h4>
					<a href="{{ URL::to('objects') }}" class="icon icon-mono impression revert">impression</a>
					...
					<a href="{{ URL::to('objects') }}" class="waves-effect waves-light btn orange" style="margin-top: 10%">Impression 3D</a>
				</div>
				<div class="col m4 hoverable" style="padding: 2%; background: rgba(44, 62, 80, 0.6);min-height: 450px;">
					...
					<p>Nos produits englobent toute la chaine de production, des logiciels de conception 3D aux imprimantes. Vous pouvez vous en procurer dès maintentant!</p>
					<a href="{{ URL::to('products') }}" class="waves-effect waves-light btn orange" style="margin-top: 10%">Boutique</a>
				</div>
...
<section class="section center" id="index-impression" style="background: url('{{ URL::to('src/img/backgrounds/map.png') }}'); background-position: center; background-repeat: no-repeat;">
	...
	<div class="row">
		<div class="col m4">
			<img src="{{ URL::to('src/img/illustrations/send.png') }}" id="img-upload">
			<h4>Envoyez vos fichiers</h4>
		</div>
		<div class="col m4">
			<img src="{{ URL::to('src/img/illustrations/print.png') }}" id="img-print">
			<h4>Nous imprimons en 3D</h4>
		</div>
		<div class="col m4">
			<img src="{{ URL::to('src/img/illustrations/receive.png') }}" id="img-reception">
			<h4>Vous les recevez</h4>
		</div>
	</div>
		<a href="{{ URL::to('objects') }}" class="waves-effect waves-light btn orange">Envoyez un fichier</a>
	</div>
</section>


<section class="section" id="news" style="background: url('{{ URL::to('src/img/backgrounds/news_index.jpg') }}'); background-attachment: fixed; background-size: cover; background-position: center;">
	<div class="container center" style="background-color: rgba(255, 255, 255, 0.8); padding: 1%;">
		...
		<div class="owl-carousel owl-theme container" id="banner-carousel" style="text-align: left;margin-top: 2%">

				<div class="row">
					<div class="col s4">
						<img src="{{ URL::to('src/img/illustrations/salle_formation.jpg') }}">
					</div>
					<div class="col s8">
						<h3>Mardi: Journée portes ouvertes!</h3>
						<p>Venez découvrir l'entreprise tous les mardi !</p>
					</div>
				</div>

				<div class="row">
					<div class="col s4">
						<img src="{{ URL::to('src/img/illustrations/java_formation.png') }}">
					</div>
					<div class="col s8">
						<h3>FORMATION: Nouvelle formation JAVA disponible</h3>
						<p>Nous vous invitons à bénéficier de notre nouvelle formation Java (Niveau 1)</p>
					</div>
				</div>
...
<section class="section no-pad" id="index-formations" style="background: #34495e">
	...
	-->
	<div class="row" style="background: url('{{ URL::to('src/img/backgrounds/formation_index.jpg') }}'); background-size: cover; background-repeat: no-repeat; background-position: left;">
		...
		<div class="col m6 s12 center" style="padding: 2%; background: rgba(255, 255, 255, 0.8);">
			...
			<div>
				<a href="{{ URL::to('contact') }}#formation" class="waves-effect waves-light btn orange" style="margin-top: 2%;">Nous contacter</a>
			</div>
		</div>
	</div>
	</div>
				...
				<a href="{{ URL::to('domaines') }}" class="waves-effect waves-light btn orange">Tous les secteurs</a> -->
					  <div class="row">
					    <div class="col m4 s12 industry-item">
					    	<a href="{{ URL::to('domaines/dentaire') }}">
						      	<img class="responsive-img" src="{{ URL::to('src/img/illustrations/domaine_dentaire.png') }}">
						      	<h5>Dentaire</h5>
					    	</a>
						      	<p>Mordernisez votre façon de travailler en adoptant l'impression 3D comme méthode.</p>
						      	<a href="{{ URL::to('domaines/dentaire') }}" class="waves-effect waves-light btn orange white-text">Découvrir</a>
					    </div>
					     <div class="col m4 s12 industry-item">
					     	<a href="{{ URL::to('domaines/joaillerie') }}">
						    <img class="responsive-img" src="{{ URL::to('src/img/illustrations/domaine_bijouterie.png') }}">
						      	<h5>Bijouterie</h5>
							</a>
						      	<p>Améliorez la précision de vos bijoux et leur temps de conception!</p>
						      	<a href="{{ URL::to('domaines/joaillerie') }}" class="waves-effect waves-light btn orange white-text">Découvrir</a>
					    </div>
					     <div class="col m4 s12  industry-item">
					     	<a href="{{ URL::to('domaines/prototypage') }}">
						     <img class="responsive-img" src="{{ URL::to('src/img/illustrations/domaine_prototypage.png') }}">
						      	<h5>Prototypage</h5>
						    </a>
						      	<p>Vous avez une idée et vos voulez la concrétiser ?  Nos services sont fait pour vous.</p>
						      	<a href="{{ URL::to('domaines/prototypage') }}" class="waves-effect waves-light btn orange white-text">Découvrir</a>
					    </div>
					    <!--
...
<section class="section no-pad" id="index-boutique" style="background: url('{{URL::to('src/img/backgrounds/formlabs-form-2.jpg')}}'); background-size: contain; background-repeat: no-repeat; background-position: center;">
	...
	<div class="container center" style="padding: 4%">
		<div class="row">
			...
			-->
			<div class="col m4 offset-m4 s12" style="color: #ffffff">
				<h2>Equipez-vous !</h2>
				<p>Notre équipe vous conseillera pour vous doter de l'un de nos produits. Un investissement plus que nécessaire pour votre développement qui vous offrira un gain de temps considérable.</p>
				<a href="{{ URL::to('products') }}" class="waves-effect waves-light btn orange">Boutique</a>
			</div>
		</div>
	</div>
	</div>
